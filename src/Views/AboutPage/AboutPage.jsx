  ...
  return (
    <div>
      <div className={`${styles["headerDiv1"]}`}>
        ...
        <div className={`${styles["about-container"]}`}>
          ...
          <p>
            ...
            facere eligendi esse explicabo laborum repudiandae corporis eligendi
            esse explicabo laborum repudiandae corporis
            <br />
      ...
      <section class={`${styles["objectives"]}`}>
        ...
        <p>
          Sri Lanka's largest collection of education courses, scholarships and
          events from best universities and institutions. Courses for After A/L
          or O/L students.
          <br />
          Sri Lanka's largest collection of education courses, scholarships and
          events from best universities and institutions. Courses for After A/L
          or O/L students.Sri Lanka's largest collection of education courses,
          scholarships and events from best universities and institutions.
          Courses for After A/L or O/L students.
        </p>
