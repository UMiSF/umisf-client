...
import styles from "./organizerPaymentsPage.module.css";
...
const OrganizerPaymentsPage = () => {
  ...
  return (
    <div className={`${styles["tournament-container"]}`}>
      ...
      <OrganizerNavbar page="payments" />

      <div className={`${styles["main-title"]}`}>
        <a href="/organizer/payments">Payments</a>
      ...
      <div className={`${styles["tool-bar"]}`}>
        <a href={"/organizer/payments/add-new-payment"}>
          ...
          <div>
            ...
            <div>
              {filteredDetails.map((payment, index) => (
                <Link to="/organizer/payments/edit-payment" state={payment}>
