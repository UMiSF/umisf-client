        ...
        <MDBModalDialog centered>
          <MDBModalContent>
            ...
            <MDBModalBody>
              ...
              <br/>
              <a target="_blank" rel="noopener noreferrer" href="https://forms.gle/3tjtdsdpSYm7PDBA6" className={`${styles['register-links']}`}>
                University Team
              </a>
              <br/>
              ...
              <br/>
              <a target="_blank" rel="noopener noreferrer" href="https://forms.gle/VXG6pf3wDpAgQ8ev9" className={`${styles['register-links']}`}>
                University Staff
              </a>
              <br/>
