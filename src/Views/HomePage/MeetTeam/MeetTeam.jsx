      ...
      <div className={`${styles["team"]}`}>
        ...
        Our team is a family, that consists of dynamic and diverse individuals
         with a close-knit bond that extends beyond the court. We share a deep
          love and passion for the sport of badminton, which serves as a unifying
           force that brings us together. The commitment to support one another 
           both on and off the court, whether it's through cheering each other 
           during games or being there for each other in tough times, creates a 
           sense of belonging and trust that strengthens our team and helps us to
            achieve our goals both individually and as a collective unit.
        </div>
      </div>
